...
namespace OnPhp {
    ...
    class SocketMemcached extends CachePeer
    {
        ...
        /**
         * SocketMemcached constructor.
         * @param string $host
         * @param int $port
         * @param int $buffer
         */
        public function __construct($host = self::DEFAULT_HOST, $port = self::DEFAULT_PORT, $buffer = self::DEFAULT_BUFFER)
        {
            $errno = $errstr = null;
         ...
         */
        public function setTimeout($microseconds) : SocketMemcached
        {
