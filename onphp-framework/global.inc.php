...
{
    throw new OnPhp\BaseException($string, $code);
}
// file extensions
...
OnPhp\AutoloaderPool::set('onPHP', $autoloader = new $autoloader());
/* @var $autoloader OnPhp\AutoloaderClassPathCache */
$autoloader
    ->setNamespaceResolver(new OnPhp\NamespaceResolverOnPHP())
    ->register();
$autoloader
    ->addPaths(
        [
            ...
            ONPHP_MAIN_PATH . 'EntityProto' . DIRECTORY_SEPARATOR,
            ...
            ONPHP_MAIN_PATH . 'Utils' . DIRECTORY_SEPARATOR . 'Turing',
            ...
            ONPHP_MAIN_PATH . 'ServiceLocator',
